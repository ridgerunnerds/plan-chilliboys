  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-3 z-40 w-10 h-10 rounded-full bg-steel-800/80 border border-steel-600 hover:border-chilliblue-400 flex items-center justify-center transition-colors group"
